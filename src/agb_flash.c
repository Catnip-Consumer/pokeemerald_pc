...
COMMON_DATA _DLL_ const struct FlashType *gFlash = NULL;
...
#ifdef PORTABLE
extern u32 VerifyFlashSector(u16 sectorNum, u8 *src);
extern u32 VerifyFlashSectorNBytes(u16 sectorNum, u8 *src, u32 n);
#endif
