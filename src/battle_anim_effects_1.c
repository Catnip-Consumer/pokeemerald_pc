...
void AnimTask_MoonlightEndFade(u8 taskId)
{
    ...
    c = a | b;
    StorePointerInVars((intptr_t*) &gTasks[taskId].intPtr, (void *)c);
...
static void AnimTask_MoonlightEndFade_Step(u8 taskId)
{
    ...
    case 1:
        if (!gPaletteFade.active)
        {
            ...
            {
                if (gSprites[spriteId].template_ == &gMoonSpriteTemplate || gSprites[spriteId].template_ == &gMoonlightSparkleSpriteTemplate)
