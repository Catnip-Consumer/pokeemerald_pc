...
static double drawAccumulator = 0.0;
static uint64_t lastGameTime = 0;
...
bool initSDL() {
	...
	const auto requestedSize = displaySize * ImVec2(GRID_COLS, GRID_ROWS);
